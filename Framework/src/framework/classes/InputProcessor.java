 ...
 */
public class InputProcessor extends FrameworkObject{

//    public static final int MOUSE_BUTTONS_COUNT = 3;
//    private static MouseInputProcessorListener mMouseInputProcessorListener;
//
//    /**
//     * 0 - Left Mouse Button
...
//                if(mMouseInputProcessorListener != null){
//                    mMouseInputProcessorListener.onMouseButtonDown(MouseButton.fromValue(mouseKeyNum), mousePosition);
//                }
//
//
...
//                //notify listener of mouse key down
//                if(mMouseInputProcessorListener != null){
//                    mMouseInputProcessorListener.onMouseButtonUp(MouseButton.fromValue(mouseKeyNum), mousePosition);
//                }
//
...
//    }
//
//    public static MouseInputProcessorListener getMouseInputProcessorListener() {
//        return mMouseInputProcessorListener;
//    }
//
//    public static void setMouseInputProcessorListener(MouseInputProcessorListener mouseInputProcessorListener) {
//        mMouseInputProcessorListener = mouseInputProcessorListener;
//    }
}
