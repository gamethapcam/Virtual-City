 ...
 * Time: 18:48
 */
public class SmallHouseIcon extends Model2dBase implements Icon {
...
//    }
    ...
    public SmallHouseIcon(SmallHouseIcon houseIcon) {
        super(AssetManager.getAsset2D(Assets2D.SMALL_HOUSE_ICON),
                new Rectangle(
    ...
    @Override
    public Icon clone() {
        return new SmallHouseIcon(this);
    }
